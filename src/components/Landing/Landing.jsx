...
import HaxyLogo from "./../../assets/Images/haxy-logo.png"

export function Features() {
    return (
        <div className=" py-2 md:px-[10%] md:py-10 px-4 w-full">
            <h1 className="text-2xl font-bold capitalize text-black lg:text-3xl">
                Why Haxy?
            </h1>
            <p className="my-2 text-gray-600">
                Are you tired of the hassle and time-consuming process of setting up your development environment? Look no further! Haxy is here to revolutionize the way you deploy and manage your development environments with simplicity, speed, and the power of open source.
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12 xl:grid-cols-3 xl:gap-16">
                    <div  className="space-y-3">
                        ...
                        <h1 className="text-xl font-semibold capitalize text-black">Seamless Deployment
                        </h1>
                        <p className="text-sm text-gray-500">
                            Gone are the days of complex setup procedures. OpenDevDeploy provides a one-click deployment solution that gets you up and running in no time. Spend less time configuring and more time coding.
                    ...
                    <div  className="space-y-3">
                        ...
                        <h1 className="text-xl font-semibold capitalize text-black">Open Source, Open Possibilities

                        </h1>
                        <p className="text-sm text-gray-500">
                        We believe in the power of collaboration and transparency. OpenDevDeploy is an open-source platform, giving you the freedom to customize, extend, and contribute. Join the community and be part of the next generation of developer tools.
                    ...
                    <div  className="space-y-3">
                        ...
                        <h1 className="text-xl font-semibold capitalize text-black">Environment Consistency


                        </h1>
                        <p className="text-sm text-gray-500">
                        Ensure consistency across your team's development environments. OpenDevDeploy ensures that everyone works with the same setup, reducing compatibility issues and enhancing collaboration.
                    ...
                    <div  className="space-y-3">
                        ...
                        <h1 className="text-xl font-semibold capitalize text-black">Multi-language Support

                        </h1>
                        <p className="text-sm text-gray-500">
                        Whether you're coding in Python, JavaScript, Java, or any other language, OpenDevDeploy supports a wide range of development stacks. It's versatile enough to adapt to your language preferences.
        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-8">
            <a href="#">
              ...
              <img src={HaxyLogo} alt="" className='w-[100px]' />       
                    ...
                    <div className="relative mx-auto max-w-2xl py-24">
                        ...
                        <div className="text-center">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-600">
                                Your Partner to Effortless Development Environments.
                            </p>
